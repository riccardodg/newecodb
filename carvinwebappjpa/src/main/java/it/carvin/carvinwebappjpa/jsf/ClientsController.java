...
import it.carvin.carvinwebappjpa.entities.ClientsFacade;
...
public class ClientsController implements Serializable {
    ...
    @EJB
    private it.carvin.carvinwebappjpa.entities.ClientsFacade ejbFacade;
    ...
    public Clients getClients(java.lang.String id) {

...
import it.carvin.carvinwebappjpa.entities.ContractsFacade;
...
public class ContractsController implements Serializable {
    ...
    private Contracts current;
    private DataModel items = null;
    @EJB
    private it.carvin.carvinwebappjpa.entities.ContractsFacade ejbFacade;
    ...
    private ContractsFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Contracts) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ContractsCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ContractsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ContractsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Contracts getContracts(java.lang.String id) {
    ...
    public static class ContractsControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Contracts) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Contracts.class.getName());
            }
        }
